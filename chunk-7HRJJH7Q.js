...
`}ngOnChanges(t){we(this,null,function*(){let n=yield import("./chunk-3CU77BGN.js");this.formattedCode=n.default.html(this.prefix+t.code.currentValue+this.suffix,{})}).catch(console.error)}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=d({type:e,selectors:[["app-output"]],inputs:{code:"code"},standalone:!0,features:[pe,f],decls:4,vars:2,consts:[["appearance","secondary","tuiIconButton","","icon","tuiIconCopyLarge","type","button",1,"float-right",3,"cdkCopyToClipboard"]],template:function(n,o){n&1&&(s(0,"section"),_(1,"button",0),s(2,"pre"),w(3),c()()),n&2&&(F(),S("cdkCopyToClipboard",o.formattedCode),F(2),Ve(o.formattedCode))},dependencies:[Ut,Gt,L,W],styles:["pre[_ngcontent-%COMP%]{display:block;border:2px solid black;white-space:pre-wrap;word-break:break-all}"]});let i=e;return i})();var Mr=(()=>{let e=class e{constructor(){this.code=""}onGenerateCode(t){this.code=t}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=d({type:e,selectors:[["app-editor"]],standalone:!0,features:[f],decls:3,vars:1,consts:[[3,"onGenerateCode"],[3,"code"]],template:function(n,o){n&1&&(s(0,"div")(1,"app-input",0),u("onGenerateCode",function(m){return o.onGenerateCode(m)}),c(),_(2,"app-output",1),c()),n&2&&(F(2),S("code",o.code))},dependencies:[Lt,qt]});let i=e;return i})();export{Mr as EditorComponent};
